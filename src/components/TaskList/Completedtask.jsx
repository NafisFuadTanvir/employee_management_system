...
const Completedtask = ({data}) => {
    return (
        <div className='h-full p-5 flex-shrink-0 w-[300px] bg-green-500 rounded-xl'>
        ...
        <p className='text-sm mt-2'>{data.task_description}</p>
           ...
           <div className='flex justify-between mt-4'>
            <button className='w-full bg-purple-800 py-1 px-2 text-sm rounded-lg'>Complete</button>
